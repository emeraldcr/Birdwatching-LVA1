...
const heroImages = [
  '/images/birdwatching/hero-blue-tanager.svg',
  '/images/birdwatching/hero-hummingbird.svg',
  '/images/birdwatching/woodpecker-forest.svg',
];

const gallery = [
  {
    src: '/images/birdwatching/woodpecker-forest.svg',
    alt: 'Pájaro carpintero entre ramas de bosque tropical',
    label: 'Bosque vivo',
  },
  {
    src: '/images/birdwatching/hummingbird-flower.svg',
    alt: 'Colibrí alimentándose en una flor tropical',
    label: 'Colibríes',
  },
  {
    src: '/images/birdwatching/tanager-branch.svg',
    alt: 'Ave colorida posada sobre una rama verde',
    label: 'Tangaras',
  },
  {
    src: '/images/birdwatching/birdwatcher-trail.svg',
    alt: 'Observador de aves caminando por senderos de bosque',
    label: 'Senderos privados',
  },
  {
    src: '/images/birdwatching/lookout-gear.svg',
    alt: 'Equipo fotográfico y binoculares para observación de aves',
    label: 'Fotografía',
  },
  {
    src: '/images/birdwatching/blackbird-leaf.svg',
        ...
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] bg-[#07180f] text-white shadow-2xl shadow-emerald-950/20">
          <div className="grid lg:grid-cols-[1.1fr_.9fr]">
            ...
            <div className="relative min-h-[24rem]">
              <img
                src="/images/birdwatching/white-bird-canopy.svg"
